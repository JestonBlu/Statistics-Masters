...
#postscript("u:/meth1/psfiles/box1sampdistweib.ps",height=8,horizontal=F)

boxplot(m10,m25,m100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Mean",
          main="Boxplots of 1000 Sample Means from Weibull(.62,.61)",
                  names=c("10","25","100"),cex=.75)  

 
#postscript("u:/meth1/psfiles/box2sampdistweib.ps",height=8,horizontal=F)
   
boxplot(q10,q25,q100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Median",
          main="Boxplots of 1000 Sample Medians from Weibull(.62,.61)",
                  names=c("10","25","100"),cex=.75)   

  
#postscript("u:/meth1/psfiles/box3sampdistweib.ps",height=8,horizontal=F)

 
boxplot(s10,s25,s100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Standard Deviation",
          main="Boxplots of 1000 of Sample Std Dev from Weibull(.62,.61)",
                  names=c("10","25","100"),cex=.75)      
