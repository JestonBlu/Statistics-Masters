...
#postscript("u:/meth1/psfiles/box1sampdistnorm.ps",height=8,horizontal=F)

boxplot(m10,m25,m100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Mean",
          main="Boxplots of 1000 Sample Means from N(0,1)",
                  names=c("10","25","100"),cex=.75)  

 
#postscript("u:/meth1/psfiles/box2sampdistnorm.ps",height=8,horizontal=F)
   
boxplot(q10,q25,q100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Median",
          main="Boxplots of 1000 Sample Medians from N(0,1)",
                  names=c("10","25","100"),cex=.75)   

  
#postscript("u:/meth1/psfiles/box3sampdistnorm.ps",height=8,horizontal=F)

 
boxplot(s10,s25,s100,xlab="Sample Size",lab=c(10,10,7),
                  ylab="Sample Standard Deviation",
          main="Boxplots of 1000 of Sample Std Dev from N(0,1)",
                  names=c("10","25","100"),cex=.75)      
